 ...
 * 
 * worst case: N + M*LogBase2N 
 * 
 * cost model : initialize = N ; union = logN - includes cost of finding roots ; find = N - worst case
...
public class QuickUnionWeightedPathCompressionUF {
	...
	public int root(int i) {
		while ( i != id[i] ) {
			// extra line for path compression
			//earlier 6 -> 5 -> 4 now 6 -> 4 and 5 -> 4 
			id[i] = id[id[i]];
			//
			i = id[i];
		}
